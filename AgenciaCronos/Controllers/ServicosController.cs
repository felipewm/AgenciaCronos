...
namespace AgenciaCronos.Controllers
{
    public class ServicosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeServico,Tipo,DataServico,Descricao")] Servico servico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeServico,Tipo,DataServico,Descricao")] Servico servico)
        {
            if (id != servico.Id)
            {
                return NotFound();
